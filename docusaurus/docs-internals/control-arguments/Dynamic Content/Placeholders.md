...
For replacing the placeholders in the menu HTML structure, you can follow this example https://github.com/EasyBrizy/builder/tree/main/packages/brizy-content-placeholder/src/examples/menu
