...
Brizy's internal link control lets you easily redirect users to any page within your website. This feature enhances navigation, improving user experience by seamlessly guiding visitors to related content or important sections.

Example of the internal link:

![Internal Link](/img/data-controls/internalLink.png)

Example of the internal link search:

![Internal Link Search](/img/data-controls/internalLinkSearch.png)

Example of the internal link result:
