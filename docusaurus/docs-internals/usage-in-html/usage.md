...
const Paragraph = (props: Props): JSX.Element => {
  ...
  const style = { textShadow: `${textShadowHorizontal}px ${textShadowVertical}px ${textShadowBlur}px ${textShadowColorHex}` }

  return <p className="brz-paragraph" style={style}>text</p>
}
