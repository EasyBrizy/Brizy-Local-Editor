import { AlphaMap2Html, AlphaMap2React } from "@brizy/builder-ui";
...
///// TODO: need to use only 1 component for both ( editor and preview ) because HTML didn't change
export const Map = ({ address, zoom }: Props): JSX.Element => (
  <AlphaMap2React address={address} zoom={zoom} />
);
