      ...
      <div className="card shadow-none rounded-0 w-100">
        ...
        <div className="card-header" id="kt_help_header">
          ...
          <div className="card-toolbar">
            <button type="button" className="btn btn-sm btn-icon explore-btn-dismiss me-n5" id="kt_help_close">
        ...
        <div className="card-body" id="kt_help_body">
          ...
          >
            ...
            <div className="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
              ...
              {/* begin::Link */}
              <a href="https://devs.keenthemes.com" className="btn btn-lg explore-btn-primary w-100">
                Get Support
              </a>
              {/* end::Link */}
            </div>
            ...
            <div className="d-flex align-items-center mb-7">
              ...
              <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                ...
                <div className="d-flex flex-column me-2 me-lg-5">
                  {/* begin::Title */}
                  <Link href="/builder" className="text-gray-900 text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">
                    Layout Builder
                  </Link>
                  {/* end::Title */}
                  {/* begin::Description */}
                  <div className="text-muted fw-bold fs-7 fs-lg-6">Dynamically modify and preview layout</div>
                  {/* end::Description */}
                </div>
                {/* end::Wrapper */}
                <KTIcon iconName="arrow-right" className="text-gray-500 fs-2" />
