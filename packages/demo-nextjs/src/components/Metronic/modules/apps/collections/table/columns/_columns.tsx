...
const getUsersColumns = (disabledFields: ID[], editable: boolean): ReadonlyArray<Column<Collection>> => {
  const columns: ReadonlyArray<Column<Collection>> = [
    {
  ...
  return columns.filter((column) => !disabledFields.includes(column.id));
};
