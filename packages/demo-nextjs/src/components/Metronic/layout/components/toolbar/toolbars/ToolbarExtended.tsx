    ...
    <>
      ...
      <div className="d-flex align-items-center overflow-auto">
        ...
        <div className="position-relative my-1">
          <KTIcon iconName="magnifier" className="fs-3 text-gray-500 position-absolute top-50 translate-middle ps-10" />
          <input
            type="text"
        ...
        {/* begin::Label */}
        <span className="fs-7 fw-bold text-gray-700 flex-shrink-0 pe-4 d-none d-md-block">Sort By:</span>
        {/* end::Label */}
