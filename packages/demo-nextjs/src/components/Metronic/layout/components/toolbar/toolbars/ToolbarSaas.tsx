  ...
  return (
    <div className="d-flex align-items-center gap-2">
      ...
      <div className="d-flex align-items-center">
        {/* begin::Label */}
        <span className="fs-7 fw-bold text-gray-700 pe-4 text-nowrap d-none d-md-block">Sort By:</span>
        {/* end::Label */}
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="d-flex align-items-center ps-4">
          <div id="kt_app_toolbar_slider" className="noUi-target noUi-target-success w-75px w-xxl-150px noUi-sm"></div>
