...
import { ActionResolve, Config, Modes, Target } from "@/types/types";
...
type IntegrationConfig = Config["integration"];
...
export const init = (config: Config, uid: string, token: string): ActionResolve => ({
  uid,
